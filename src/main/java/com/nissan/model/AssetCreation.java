...
public class AssetCreation {
	...
	public AssetCreation(String aMModel, String aMSerialNum, AssetType aMTypeId, Vendors aMMakerId,
	...
	public String toString() {
		return "AssetCreation [aMId=" + aMId + ", aMModel=" + aMModel + ", aMSeraialNum=" + aMSerialNum + ", aMMyYear=" + aMMyYear
